...
<html>
    ...
    <div class="header">
        ...
        <br><br>
    <h2>Anime to Watch This Season</h2>
    <div class="anime-section">
        <div class="anime-container">
        <?php
            $animeIds = array(1, 2, 6, 22);
            $sql = "SELECT * FROM Animes WHERE ID IN (" . implode(', ', $animeIds) . ")";
...
<h2>Check out the creator's favourite</h2>
<div class="creator-section">
        <div class="creator-container">
        <?php
            $animeIds = array(2, 7, 13, 4);
            $sql = "SELECT * FROM Animes WHERE ID IN (" . implode(', ', $animeIds) . ")";
            $result = mysqli_query($conn, $sql);
